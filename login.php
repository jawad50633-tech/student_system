...
<head>
    ...
    <style>
        body {
            background: linear-gradient(rgba(6, 11, 40, 0.8), rgba(6, 11, 40, 0.8)), url('https://images.unsplash.com/photo-1620712943543-bcc4628c9455?q=80&w=2000&auto=format&fit=crop') no-repeat center center fixed;
